...
%% The below command creates the ligh bulb logos in the top right corner 
\definecolor{mypurple}{RGB}{128,0,128}

\setbeamercolor{subsection title}{fg=mypurple}
...
\begin{frame}[plain]
	\makebox[\linewidth][c]{%
		\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{\rootdir common-resources/img/msfr-intro-slide.png}%
	}
\end{frame}
...
\setbeamertemplate{background}{%
  \includegraphics[width=\paperwidth,height=\paperheight]{common-resources/img/title-slide.png} % Specific background for the title slide
}
