...
<font size="7">Go to <a href="http://bit.ly/msfr24_materials">http://bit.ly/msfr24_materials</a> and download <b>4-data-vis.pdf</b></font>
...
1\. Start by doing some data wrangling to collapse `df_hh` by enumerator:
...
Create a bar plot of the average survey time per enumerator.
...
Before you're left on your own wandering in the fascinating world of R programming and start coding to your heart's content, **please provide for today's MSFR sessions**:

- Link: https://bit.ly/msfr24_day3

```{r echo = FALSE, out.width="35%"}
knitr::include_graphics("img/4-data-vis/bit.ly_4b6saSs.png")
```
