...
```{r, eval=FALSE}
df_village <- readRDS(here("Data", "DataWork", "data", "intermediate", "tidy", "tidy-village.Rds")) %>% clean_names()
df_hh      <- readRDS(here("Data", "DataWork", "data", "intermediate", "tidy", "tidy-HH.Rds")) %>% clean_names()
df_food    <- readRDS(here("Data", "DataWork", "data", "intermediate", "tidy", "tidy-food-consumption.Rds")) %>% clean_names()
```
...
# Saving
saveRDS(df_village_labelled,
        here(output_folder, "LWH-villages-clean.Rds"))
saveRDS(df_food_factors,
        here(output_folder, "LWH-food-clean.Rds"))
saveRDS(df_hh_labelled,
        here(output_folder, "LWH-households-clean.Rds"))
```
