...
```{r, eval=FALSE}
df_village <- readRDS(here("Data", "DataWork", "data", "intermediate", "tidy", "tidy-village.Rds")) %>% 
  clean_names()
df_hh      <- readRDS(here("Data", "DataWork", "data", "intermediate", "tidy", "tidy-HH.Rds")) %>% 
  clean_names()
df_food    <- readRDS(here("Data", "DataWork", "data", "intermediate", "tidy", "tidy-food-consumption.Rds")) %>% 
  clean_names()
```
